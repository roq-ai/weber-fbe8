...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'researcher', 'scientist', 'collaborator', 'guest-user'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Citations', path: '/citations', entity: 'citation', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    {
      name: 'Collaborations',
      path: '/collaborations',
    ...
    { name: 'Patents', path: '/patents', entity: 'patent', service: AccessServiceEnum.PROJECT, icon: FiBriefcase },
    ...
    { name: 'Research', path: '/research', entity: 'research', service: AccessServiceEnum.PROJECT, icon: FiBook },
    {
    ...
    { name: 'Workshops', path: '/workshops', entity: 'workshop', service: AccessServiceEnum.PROJECT, icon: FiTool },
