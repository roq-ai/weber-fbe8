  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Weber - Uniting researchers and scientists worldwide through a dedicated social network, fostering collaboration and innovation."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1501290741922-b56c0d0884af?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyZXNlYXJjaHxlbnwwfHx8fDE2OTc1Mzg0MjV8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@dandimmock?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Dan Dimmock`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Weber - Uniting researchers and scientists worldwide through a dedicated social network, fostering collaboration and innovation.`}
            </Text>
            <Box
