...
import { useResearchFindFirst, useRoqClient } from 'lib/roq';

import { ResearchInterface } from 'interfaces/research';
import { PublicationListPage } from 'pages/publications';
...
function ResearchViewPage() {
  ...
  const { data, error, isLoading } = useResearchFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('research', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/research/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Abstract" text={data?.abstract} />
